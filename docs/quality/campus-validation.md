...
- Écrans initiaux ordinateur, mobile 390 px et tablette 820 px : aucun débordement horizontal observé, logos chargés ; aucune erreur/alerte console relevée. Extension contrôlée sur ordinateur et fenêtre de 639 px ; le navigateur n'a pas appliqué systématiquement les nouvelles tailles demandées pendant la configuration externe.
