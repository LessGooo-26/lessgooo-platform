  ...
  return (
    <>
      <Hero
        ...
        primaryAction={{ label: home.explorePrograms, to: publicRoutes.programs }}
        secondaryAction={{ label: home.learnAbout, to: publicRoutes.about }}
      />
      <Section labelledBy="approach-title">
        <SectionHeading id="approach-title" eyebrow={home.approachEyebrow} title={home.approachTitle} description={home.approachIntroduction} />
        <div className="feature-grid">
          {home.features.map((feature, index) => (
            <FeatureCard key={feature.title} number={String(index + 1).padStart(2, '0')} title={feature.title} description={feature.description} />
          ))}
        </div>
      </Section>
      ...
      <Section labelledBy="programs-title" tone="subtle">
        <SectionHeading id="programs-title" eyebrow={home.programsEyebrow} title={home.programsTitle} description={home.programsIntroduction} />
        <div className="program-grid">
          {content.programs.map((program) => (
            <ProgramCard key={program.routeId} title={program.title} description={program.description} linkLabel={home.learnMore} to={publicRoutes[program.routeId]} />
          ))}
        </div>
      </Section>
